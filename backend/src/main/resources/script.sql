...
ALTER TABLE ONLY public.tb_product_delivery
    ADD CONSTRAINT tb_product_delivery_pkey PRIMARY KEY (product_id, delivery_id);
...
--
-- Name: tb_employee uk22ko230cujoq6y7rw84wuwvy; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tb_employee
    ADD CONSTRAINT uk22ko230cujoq6y7rw84wuwvy UNIQUE (cpf);


--
-- Name: tb_product uk5ryhtrjtfy46388ijrckcrxwo; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tb_product
    ADD CONSTRAINT uk5ryhtrjtfy46388ijrckcrxwo UNIQUE (bar_code);


--
-- Name: tb_supplier ukd5wft4tdxylej2g9jkp36i4kf; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tb_employee ukem9lvg7whqbrro5fbav5bt0gy; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tb_employee
    ADD CONSTRAINT ukem9lvg7whqbrro5fbav5bt0gy UNIQUE (email);
