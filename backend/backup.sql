CREATE TABLE postgres.tb_delivery (
...
ALTER TABLE postgres.tb_delivery ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME postgres.tb_delivery_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE postgres.tb_employee (
...
ALTER TABLE postgres.tb_employee ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME postgres.tb_employee_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE postgres.tb_employee_role (
...
CREATE TABLE postgres.tb_payment (
...
ALTER TABLE postgres.tb_payment ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME postgres.tb_payment_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE postgres.tb_product (
...
CREATE TABLE postgres.tb_product_delivery (
...
ALTER TABLE postgres.tb_product ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME postgres.tb_product_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE postgres.tb_role ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME postgres.tb_role_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE postgres.tb_sale ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME postgres.tb_sale_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE postgres.tb_sale_item (
    price double precision NOT NULL,
...
CREATE TABLE postgres.tb_supplier (
...
ALTER TABLE ONLY postgres.tb_delivery
...
ALTER TABLE ONLY postgres.tb_employee
...
ALTER TABLE ONLY postgres.tb_employee_role
...
ALTER TABLE ONLY postgres.tb_payment
...
ALTER TABLE ONLY postgres.tb_product
...
ALTER TABLE ONLY postgres.tb_product_delivery
...
ALTER TABLE ONLY postgres.tb_role
...
ALTER TABLE ONLY postgres.tb_sale_item
...
ALTER TABLE ONLY postgres.tb_sale
...
ALTER TABLE ONLY postgres.tb_supplier
    ADD CONSTRAINT tb_supplier_cnpj_key UNIQUE (cnpj);


--
-- Name: tb_supplier tb_supplier_name_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY postgres.tb_supplier
    ADD CONSTRAINT tb_supplier_name_key UNIQUE (name);
...
ALTER TABLE ONLY postgres.tb_sale
    ADD CONSTRAINT fk20unxq4gx5kiemos3y4yrv285 FOREIGN KEY (employee_id) REFERENCES postgres.tb_employee(id);
...
ALTER TABLE ONLY postgres.tb_employee_role
    ADD CONSTRAINT fk5a1thqkyfisgd225gsrauel61 FOREIGN KEY (employee_id) REFERENCES postgres.tb_employee(id);


--
-- Name: tb_product fkhfw2m846pdodwbaswf9qy5s70; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY postgres.tb_product
    ADD CONSTRAINT fkhfw2m846pdodwbaswf9qy5s70 FOREIGN KEY (supplier_id) REFERENCES postgres.tb_supplier(id);
...
ALTER TABLE ONLY postgres.tb_payment
    ADD CONSTRAINT fkhl0nnsn2x5cqc4avi989dfh8r FOREIGN KEY (sale_id) REFERENCES postgres.tb_sale(id);
...
ALTER TABLE ONLY postgres.tb_product_delivery
    ADD CONSTRAINT fkhm7914pwx8wk680kvv328pkb2 FOREIGN KEY (delivery_id) REFERENCES postgres.tb_delivery(id);
...
ALTER TABLE ONLY postgres.tb_sale_item
    ADD CONSTRAINT fkm127ckuaearcl3vyfxnb8e2i6 FOREIGN KEY (sale_id) REFERENCES postgres.tb_sale(id);
...
ALTER TABLE ONLY postgres.tb_product_delivery
    ADD CONSTRAINT fkngr6x4wwp28k0ppp8p5eoucc5 FOREIGN KEY (product_id) REFERENCES postgres.tb_product(id);
...
ALTER TABLE ONLY postgres.tb_employee_role
    ADD CONSTRAINT fkpivoptm0s5gsnqtel1xc5tjwg FOREIGN KEY (role_id) REFERENCES postgres.tb_role(id);
...
ALTER TABLE ONLY postgres.tb_delivery
    ADD CONSTRAINT fkt0kndbhgytpc47lelhy2tg5yk FOREIGN KEY (supplier_id) REFERENCES postgres.tb_supplier(id);
...
ALTER TABLE ONLY postgres.tb_sale_item
    ADD CONSTRAINT fkty6njf75edhxfqch4el0djkq FOREIGN KEY (product_id) REFERENCES postgres.tb_product(id);
